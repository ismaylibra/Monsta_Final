...
namespace Watch.DAL.Migrations
{
    ...
    [Migration("20230215223751_AddedProfileImageColumnToContactMessageTable")]
    partial class AddedProfileImageColumnToContactMessageTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Watch.Core.Entities.AdvertisementBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Watch.Core.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Watch.Core.Entities.OrderItem", b =>
                {
                    b.HasOne("Watch.Core.Entities.Order", "Order")
                        .WithMany("OrderItems")
